...
import { DroppedAsset, errorHandler, getCredentials, initializeBreakoutSession } from "../../utils/index.js";
...
export const handleGetDroppedAsset = async (req: Request, res: Response) => {
  try {
    ...
    await initializeBreakoutSession(droppedAsset as IDroppedAsset);
